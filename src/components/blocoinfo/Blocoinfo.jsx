...
const Blocoinfo = (props) => {
  // guarda as informações que definem que o valor inicial é em R$
  const moeda = {
    acessoIndiceTotal: 1,
    simbolo: "R$",
    localeString: "pt-BR",
        ...
        <div className="blocoinfo">
          <div className="container-partesuperior">
            <div className="campanha">
              <h1>
                <FormattedMessage id="campanhaum" />
              </h1>
            </div>
            ...
            <div className="informacao">
              <h3>
                <FormattedMessage id="iniciocamp" />{" "}
                {valores.totalDoacoesCampanhas}
                <FormattedMessage id="informacaocamp" />{" "}
                <a
                  href="https://docs.google.com/spreadsheets/d/1RA0oP9EBHxpsLGvHTaX2TTYHT2oQHTfNrM8Z40hqVus/edit#gid=0"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <span className="informacaoaqui">
                    <FormattedMessage id="informacaoaqui" />
                  </span>
                </a>{" "}
                <FormattedMessage id="informacaocampdois" />
              </h3>
            </div>
            <div></div>
          </div>
