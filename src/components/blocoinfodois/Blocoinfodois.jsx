    ...
    <div className="blocodois">
                    ...
                    <div className="container-texto">
                        ...
                        <div className="textotitulo">
                            ...
                            <div className="botao">
                           <a className="botao-h1" href="https://docs.google.com/spreadsheets/d/1RA0oP9EBHxpsLGvHTaX2TTYHT2oQHTfNrM8Z40hqVus/edit#gid=0" target="_blank"><FormattedMessage id= "pessoasdoando" /></a>
                            </div>
                        </div>
                    ...
                    <div className="container-qr-qrcode">
                        ...
                        <p><FormattedMessage id="textcode" /><br />
                            ...
                            <FormattedMessage id="textcodedois" /><img src={seta} /></p>
                ...
                <div className="container-final">
                    ...
                    <div className="textoemail">
                        <p><FormattedMessage id="textemail1" /><br />
                            <FormattedMessage id="textemail2" /> <a className="email" href="malito:abcr@captadores.org.br" target="_blank"><FormattedMessage id="textemail3" /></a><br />
